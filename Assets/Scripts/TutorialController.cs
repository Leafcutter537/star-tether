...
public class TutorialController : MonoBehaviour
{
    ...
    [SerializeField] private GameObject pointerSecondDialogue;
    ...
    void Start()
    {
        ...
        allGameObjects = new List<GameObject>() { pointerFirstDialogue, firstDialoguePanel,
            pointerSecondDialogue, secondDialoguePanel,
            thirdDialoguePanel,
            fourthDialoguePanel,
    ...
    public void FirstStep()
    {
        ...
        pointerSecondDialogue.SetActive(true);
    ...
    {
        pointerSecondDialogue.SetActive(false);
